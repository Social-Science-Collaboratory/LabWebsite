  ...
  <div class="accordion-item">
    ...
    <div id="collapsePhD" class="collapse" aria-labelledby="headingPhD" data-parent="#contactAccordion">
      <div class="accordion-body">
        ...
        <p>Information about the application process, the program, and life at UF, is available here. Questions should be addressed to <a href="mailto:psych-info@ufl.edu">psych-info@ufl.edu</a>.</p>
        <p>To ensure fairness, we do not meet with or provide applicants with feedback. If you have reviewed information about our research group and believe there is a strong match with your interests, we encourage you to apply.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
