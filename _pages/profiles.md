...
profiles:
  ...
  - align: left
    ...
    image_circular: false # crops the image to make it circular
    more_info: >
      <p><strong>Gabrielle Grant</strong><br>RA</p>
  - align: right
    image: hannah_headshot.jpeg
    content: about_hannah.md
    image_circular: false # crops the image to make it circular
    more_info: >
      <p><strong>Hannah Johns</strong><br>RA</p>
  - align: left
    image: luc_headshot.jpeg
    content: about_luc.md
    image_circular: false # crops the image to make it circular
    more_info: >
      <p><strong>Luc NeJame</strong><br>RA</p>
---
